...
public interface DBQueries {
	String INSERT_INTO_CUSTOMER = "INSERT INTO CUSTOMER ( CUST_NAME, ORDER_DTE) VALUES(?,?)";
	...
	String SELECT_CUST_BY_ID="SELECT CUST_ID, CUST_NAME, ORDER_DTE  FROM CUSTOMER WHERE CUST_ID=?";
